...
# vid_writer = cv2.VideoWriter(f'{source_folder}output_{source_file}mp4', cv2.VideoWriter_fourcc(*fourcc), fps, (w, h))
...
while True:
    ...
    output_name = f'{output_folder}image_{str(frame).zfill(6)}.png'
